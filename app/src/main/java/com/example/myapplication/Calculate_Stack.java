...
public class Calculate_Stack {
    ...
    private String calculate(String firstValue, String secondValue, char charAt) {
        ...
        switch (charAt){
            ...
            case '*':
                ...
                break;
            case '/':
                result = num1.divide(num2, DEF_DIV_SCALE, java.math.BigDecimal.ROUND_HALF_UP).doubleValue();
                break;
        }
